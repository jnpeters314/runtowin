      ...
      <div className="bg-navy-900 text-white px-4 sm:px-6 py-5 border-b border-navy-800">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-slate-400 text-sm mt-0.5">
            A senior Democratic campaign strategist. Ask anything about fundraising, messaging, voter contact, or strategy.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border-t border-slate-200 px-4 sm:px-6 py-4">
        <div className="max-w-3xl mx-auto flex gap-3 items-end">
          <textarea
            ...
            rows={1}
            className="flex-1 resize-none border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 max-h-40 leading-relaxed"
            style={{ height: 'auto' }}
            onInput={(e) => {
        ...
        <p className="max-w-3xl mx-auto mt-2 text-xs text-slate-400 text-center">
          Campaign Coach can make mistakes. Verify important legal or compliance details with a professional.
        </p>
      </div>
    </div>
  )
